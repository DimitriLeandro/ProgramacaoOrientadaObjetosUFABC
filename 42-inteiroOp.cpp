...
Inteiro::Inteiro(string stringNumero){
	this->stringOriginal = stringNumero;
	this->tamanho = 0;
...
Inteiro* Inteiro::operator + (Inteiro inteiroB){
	Inteiro *resultado = new Inteiro(this->stringOriginal);
	resultado->soma(&inteiroB);
	return resultado;
}

Inteiro* Inteiro::operator - (Inteiro inteiroB){
	Inteiro *resultado = new Inteiro(this->stringOriginal);
	resultado->sub(&inteiroB);
	return resultado;
}

Inteiro* Inteiro::operator * (Inteiro inteiroB){
	Inteiro *resultado = new Inteiro(this->stringOriginal);
	resultado->mult(&inteiroB);
	return resultado;
}
...
int main(){
	...
	char operacao;
	Inteiro *inteiroA, *inteiroB, *resultado;
